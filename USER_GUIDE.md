...
- **Businesses** — searchable, paginated table of all ~90+ businesses (10/page) with edit/delete. There's **no "Add Business" button** — new businesses are created together with their owner via *Add Business Owner* in the Users section. The Verified column is a green/grey dot — **read-only in the UI** (changeable only in the DB).
